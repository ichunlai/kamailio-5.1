 ...
 * sets proto */
int parse_proto(
    unsigned char *s, long len, int *proto)
{
...
static struct name_lst *mk_name_lst_elem(
    char *name, int name_len, int flags)
{
    struct name_lst *l;
 ...
 *                   "(hostname)"
 */
static struct name_lst *parse_name_lst(
    char *h, int h_len)
{
    char            *last;
    char            *p;
