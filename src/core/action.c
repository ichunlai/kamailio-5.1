...
cfg_action_t *get_cfg_crt_action(
    void)
{
...
int run_actions_safe(
    struct run_act_ctx *h, struct action *a,
    struct sip_msg *msg)
{
...
int run_top_route(
    struct action *a, sip_msg_t *msg, struct run_act_ctx *c)
{
    struct run_act_ctx ctx;
