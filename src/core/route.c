...
inline static void destroy_rlist(
    struct route_list *rt)
{
 ...
 */
static int route_add(
    struct route_list *rt, char *name, int i)
{
    struct str_hash_entry *e;
...
inline static int init_rlist(
    char *r_name, struct route_list *rt,
...
static inline int route_new_list(
    struct route_list *rt)
{
    int           ret;
    struct action **tmp;
 ...
 */
int route_get(
    struct route_list *rt, char *name)
{
    int                   len;
    struct str_hash_entry *e;
    int                   i;
 ...
 */
inline static int comp_num(
    int op, long left, int rtype, union exp_op *r,
 ...
 */
inline static int comp_str(
    int op, str *left, int rtype,
...
inline static int comp_string(
    int op, char *left, int rtype, union exp_op *r,
    struct sip_msg *msg, struct run_act_ctx *h)
{
    str s;
...
inline static int comp_avp(
    int op, avp_spec_t *spec, int rtype,
    union exp_op *r, struct sip_msg *msg,
    struct run_act_ctx *h)
{
    avp_t        *avp;
 ...
 */
inline static int comp_select(
    int op, select_t *sel, int rtype,
    union exp_op *r, struct sip_msg *msg,
    struct run_act_ctx *h)
{
    int  ret;
...
inline static int comp_rve(
    int op, struct rval_expr *rve, int rtype,
    union exp_op *r, struct sip_msg *msg,
    struct run_act_ctx *h)
{
    int               i;
...
inline static int comp_pvar(
    int op, pv_spec_t *pvs, int rtype,
    union exp_op *r, struct sip_msg *msg,
    struct run_act_ctx *h)
{
    pv_value_t pval;
...
inline static int check_self_op(
    int op, str *s, unsigned short p)
{
    int ret;
...
inline static int comp_ip(
    int op, struct ip_addr *ip, int rtype,
    union exp_op *r, struct sip_msg *msg,
...
inline static int eval_elem(
    struct run_act_ctx *h, struct expr *e,
    struct sip_msg *msg)
{
    struct sip_uri     uri;
    int                ret;
...
void push(
    struct action *a, struct action **head)
{
    struct action *t;
    if (*head == 0)
    {
